...
/* NOTE: clang supports ints larger than 64 bits (__int128/__uint128),
 * long double is 16 bytes. If used with such types, compilation would
 * complain that the shift count is negative.
 * 
 * This will need to be adjusted if it's upstreamed or compiled on a
 * different platform.
 */
